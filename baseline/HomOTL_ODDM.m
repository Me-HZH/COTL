function [classifier, err_count, run_time, mistakes, mistakes_idx,score,...
    precision,recall,G_mean] = HomOTL_ODDM(Y, A, X, MEAN_Xs,MEAN_Xt,NUM_t,MEAN_ks,MEAN_kt,NUM_kt, options, id_list,classifiers)
